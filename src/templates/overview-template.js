        ...
        ? html`
          ...
          <slot name="overview-api-description"; style="color: black;">
            ...
            <div style="display: flex;">
              <button class="buttons"; part="btn-fill" style="margin-right: 20px;"><a href="/contact" style=" color: white;">Contact us</a></button>
              <button class="buttons"; part="btn-fill" @click="${(e)=>{e.preventDefault; downloadFile(JSON.stringify(this.apiObject), 'application/json', 'OpenAPI Specification')}}">Download OpenAPI specification</button>
            </div>
          </slot>
        `
        : ''
